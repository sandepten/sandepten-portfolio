...
const FailAlert: NextComponentType<NextPageContext, {}, Props> = (
  props: Props
) => {
  const [failAlert, setFailAlert] = useRecoilState(successAlertState);
  return (
    <div>
      <div
        id="alert-2"
        className="fixed top-10 left-0 right-0 mx-5 flex w-fit rounded-lg bg-red-100 p-4 dark:bg-red-200 sm:mx-auto"
        role="alert"
      >
        <svg
          aria-hidden="true"
        ...
        <div className="ml-3 text-sm font-medium text-red-700 dark:text-red-800">
          Oops something went wrong! Your message was not received
        </div>
        <button
          type="button"
